...
# exp
_C.exp = edict()
_C.exp.name = "output_seven_scenes"
...
# data
_C.data = edict()
_C.data.dataset_dir = "/media/anpei/DiskA/05_i2p_fewshot/data/7Scenes/"
...
_C.eval.rmse_threshold = 0.025 #0.1
...
_C.model.point_backbone.input_dim = 3 
